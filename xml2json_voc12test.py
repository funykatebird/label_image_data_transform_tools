...
voc2012ims = '/data/dataset/datasets/voc2012/VOCdevkit/VOC2012/JPEGImages'
# test_txt = 'voc2007/test.txt'
#test_txt = '/data2/chenjia/data/VOCdevkit/VOC2012/ImageSets/Main/test.txt'
#test_txt = '/data/dataset/datasets/voc2012/VOCdevkit/VOC2012/ImageSets/Main/test.txt'
...
json_name = 'funy_instances_voc2012train_test.json'
images = []
