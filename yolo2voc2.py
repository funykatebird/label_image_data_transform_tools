...
if __name__ == '__main__':
    ...
    txts_path1 = '/data/dataset/datasets/label_image_tools/voc2coco-pattern/voc2coco-master/data/test_yolo'
    imgs_path1 = '/data/dataset/datasets/label_image_tools/voc2coco-pattern/coco2017_voc/images'
    xmls_path1 = './Annotations_xml_funy'
